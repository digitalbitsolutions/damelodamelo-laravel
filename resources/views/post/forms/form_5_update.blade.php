...
@section('title', 'Damelo Damelo - Actualizar Terreno')
...
<form action="{{ url('/post/update') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container-title-page">
        <h2>Actualizar &raquo; <span>Terreno</span></h2>
    </div>
    <div class="container-main">
            ...
            <div class="div-col-1">
                ...
                <label for="" class="label-col-100 container-for-rent-only" style="display: none;">
                    ...
                    <div class="group-icon-input-ui-2">
                        ...
                        <input placeholder="" type="text" class="input-ui" value="<?= $property[0]["guarantee"] ?>" name="guarantee">
                    </div>
                </label>
        ...
        <div class="container-row-form box">
            ...
            <div class="div-col-1">
                ...
                <label class="radio label-radio-checkbox-col-100">
                    <label class="container-input-radio-ui"><input type="radio" <?= $wa["id"] == $property[0]["wheeled_access_id"] ? "checked" : "" ?> name="wheeled_access" value="<?= $wa["id"] ?>" required /><div class="checkmark"></div></label>
                    <?= $wa["name"] ?>
                </label>
                <?php } ?>
            </div>
            <div class="div-col-1">
                <span class="title-label">Distancia municipio m&aacute;s cercano *</span>
                <?php foreach($nearestMunicipalityDistance as $nmd){ ?>
                <label class="radio label-radio-checkbox-col-100">
                    <label class="container-input-radio-ui"><input type="radio" <?= $nmd["id"] == $property[0]["nearest_municipality_distance_id"] ? "checked" : "" ?> name="nearest_municipality_distance" value="<?= $nmd["id"] ?>" required /><div class="checkmark"></div></label>
                    <?= $nmd["name"] ?>
                </label>
                <?php } ?>
            </div>
            <div class="div-col-1">
                <label for="" class="label-col-100">
                    ...
                    <div class="group-icon-input-ui-2">
                        ...
                        <input placeholder="" type="text" class="input-ui" value="<?= $property[0]["land_size"] ?>" name="land_size">
                    </div>
                </label>
                <!-- <label for="">
        ...
        <div class="container-row-form box">
            ...
            <label for="">
                ...
                <input type="text" class="input" placeholder="https://" <?= $property[0]["page_url"] ?> name="page_url">
            </label>
        </div>
