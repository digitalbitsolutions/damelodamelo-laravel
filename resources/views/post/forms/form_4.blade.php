...
@section('title', 'Damelo Damelo - Garaje')
...
@section('subheading')
    Completa los datos para registrar Garaje
@endsection
...
<form action="{{ url('/post/create') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container-title-page">
        <h2>Complete los datos para registrar &raquo; <span>Garaje</span></h2>
    </div>
    <div class="container-main">
        ...
        <h2 class="title-main-row-section">Características del garaje</h2>
        <div class="container-row-form box">
            <!-- <div class="div-col-1 container-for-sale-only">
            ...
            <label for="">
                <span class="title-label">Año de construcción del garaje</span>
            ...
            <div class="div-col-1">
                <span class="title-label">Características</span>
                <?php foreach($feature as $fe){ ?>
                <label class="checkbox label-radio-checkbox-col-100">
                    <input type="checkbox" class="checkbox-input-ui" hidden="" name="feature[]" value="<?= $fe["id"] ?>" />
                    <span class="checkmark-checkbox-input-ui"></span>
                    <?= $fe["name"] ?>
                </label>
                <?php } ?>
