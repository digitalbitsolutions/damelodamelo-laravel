...
@section('title', 'Damelo Damelo - Actualizar Piso')
...
<form action="{{ url('/post/update') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container-title-page">
        <h2>Actualizar &raquo; <span>Piso</span></h2>
    </div>
    <div class="container-main">
        ...
        <h2 class="title-main-row-section">Caracter&iacute;sticas del piso</h2>
        <div class="container-row-form box">
            <!-- <div class="div-col-1 container-for-sale-only">
        ...
        <div class="container-row-form box container-for-sale-only">
            <div class="div-col-1">
                <?php foreach($reasonForSale as $rfs){ ?>
                    <label class="radio label-radio-checkbox-col-100">
                        <label class="container-input-radio-ui"><input type="radio" <?= $rfs["id"] == $property[0]["reason_for_sale_id"]? "checked":"" ?> name="reason_for_sale" value="<?= $rfs["id"] ?>" required /><div class="checkmark"></div></label>
                        <?= $rfs["name"] ?>
                    </label>
                <?php } ?>
            </div>
