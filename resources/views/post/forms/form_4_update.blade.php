...
@section('title', 'Damelo Damelo - Actualizar Garaje')
...
<form action="{{ url('/post/update') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container-title-page">
        <h2>Actualizar &raquo; <span>Garaje</span></h2>
    </div>
    <div class="container-main">
        ...
        <div class="container-row-form box">
            ...
            <div class="div-col-1">
                    ...
                    <div class="select">
                        <select name="plant" required>
                            ...
                            <?php foreach($plant as $plnt){ 
                                if (intval($plnt["id"]) === intval($property[0]["plant_id"])){
                                    echo "<option value='".$plnt["id"]."' selected>".$plnt["name"]."</option>";
                                }else{
                                    echo "<option value='".$plnt["id"]."'>".$plnt["name"]."</option>";
                                }
                            }
                            ?>
                        </select>
                ...
                <!-- <?php $col_type_floor_id = array_column($typesFloors, "type_floor_id"); foreach($typeFloor as $tf){ ?>
                <label class="radio label-radio-checkbox-col-100">
                    <input type="checkbox" <?= in_array($tf["id"], $col_type_floor_id) ? "checked" : "" ?> class="checkbox-input-ui" hidden="" name="type_floor[]" value="<?= $tf["id"] ?>" />
            ...
            <div class="div-col-1">
                ...
                <label class="radio label-radio-checkbox-col-100">
                    <label class="container-input-radio-ui"><input type="radio" name="visibility_in_portals" <?= $vip["id"] == $property[0]["visibility_in_portals_id"] ? "checked" : "" ?> value="<?= $vip["id"] ?>" /><div class="checkmark"></div></label>
                    <?= $vip["name"]?>    
                </label>
                <?php } ?>
            </div>
        ...
        <div class="container-row-form box">
            ...
            <div class="div-col-1">
                <label for="" class="label-col-100 sale_price_label">
                    ...
                    <div class="group-icon-input-ui-2">
                        ...
                        <input placeholder="" type="text" class="input-ui" value="<?= $property[0]["sale_price"] ?>" name="sale_price" id="sale_price">
                    </div>
                </label>
                ...
                <label for="" class="label-col-100 container-for-sale-only">
                    ...
                    <div class="group-icon-input-ui-2">
                        ...
                        <input placeholder="Precio" type="text" class="input-ui" value="<?= $property[0]["ibi"] ?>" name="ibi" id="ibi">
                    </div>
                </label>
            </div>
            <div class="div-col-1 container-for-sale-only">
                ...
                <label for="" class="label-col-100 mortgage_rate_label" style="<?= empty($property[0]["mortgage_rate"])? "display: none;" : "" ?>">
                    ...
                    <div class="group-icon-input-ui-2">
                        <span class="icon-ui">&euro;</span>
                        <input placeholder="Precio" type="text" class="input-ui" value="<?= $property[0]["mortgage_rate"] ?>" name="mortgage_rate" id="mortgage_rate">
                    </div>
                </label>
            </div>
        </div>

        <h2 class="title-main-row-section container-for-sale-only">Estado de ocupaci&oacute;n</h2>
        <div class="container-row-form box container-for-sale-only">
            <div class="div-col-1">
                <span class="title-label">&iquest;Tiene inquilinos? *</span>
                <label class="radio label-radio-checkbox-col-100">
                    <label class="container-input-radio-ui"><input type="radio" <?= $property[0]["has_tenants"] == 1 ? "checked" : "" ?> name="has_tenants" value="1" required /><div class="checkmark"></div></label>
                    SI
                </label>
                <label class="radio label-radio-checkbox-col-100">
                    <label class="container-input-radio-ui"><input type="radio" <?= $property[0]["has_tenants"] == 2 ? "checked" : "" ?> name="has_tenants" value="2" required /><div class="checkmark"></div></label>
                    NO
                </label>
            </div>
        </div>
        <h2 class="title-main-row-section">Caracter&iacute;sticas del garaje</h2>
        <div class="container-row-form box">
            <!-- <div class="div-col-1 container-for-sale-only">
                ...
                <div class="select">
                    <select name="plaza_capacity" required>
                        ...
                        <?php foreach($plazaCapacity as $plc){ 
                            if (intval($plc["id"]) === intval($property[0]["plaza_capacity_id"])){
                                echo "<option value='".$plc["id"]."' selected>".$plc["name"]."</option>";
                            }else{
                                echo "<option value='".$plc["id"]."'>".$plc["name"]."</option>";
                            }    
                        }
                        ?>
                    </select>
            ...
            <!-- <div class="div-col-1">
                ...
                <label class="radio label-radio-checkbox-col-100">
                    <label class="container-input-radio-ui"><input type="radio" name="state_conservation" <?= $stCons["id"] == $property[0]["state_conservation_id"] ? "checked" : "" ?> value="<?= $stCons["id"] ?>" required /><div class="checkmark"></div></label>
                    <?= $stCons["name"] ?>
                </label>
                <?php } ?>
            </div> -->
            <div class="div-col-1">
                <label for="">
                    ...
                    <input type="text" class="input" value="<?= $property[0]["m_long"] ?>" name="m_long" required id="m_long">
                </label>
                <label for="">
                    <span class="title-label">M de ancho *</span>
                    <input type="text" class="input" value="<?= $property[0]["m_wide"] ?>" name="m_wide" required id="m_wide">
                </label>
            </div>
            <!-- <label for="">
            ...
            <!-- <div class="div-col-1">
                ...
                <label for="">
                    ...
                    <input type="text" class="input" value="<?= $property[0]["bathrooms"] ?>" name="bathrooms" required>
                </label>
            </div> -->
            <!-- <div class="div-col-1">
                <span class="title-label">Metros lineales de fachada *</span>
                <label for="">
                    <input type="text" class="input" value="<?= $property[0]["linear_meters_of_facade"] ?>" name="linear_meters_of_facade" required>
                </label>
            </div> -->
            <!-- <div class="div-col-1">
                <span class="title-label">Estancias *</span>
                <label for="">
                    <input type="text" class="input" value="<?= $property[0]["stays"] ?>" name="stays" required>
                </label>
            </div> -->
            <!-- <div class="div-col-1">
                <span class="title-label">N&uacute;mero de escaparates *</span>
                <label for="">
                    <input type="text" class="input" value="<?= $property[0]["number_of_shop_windows"] ?>" name="number_of_shop_windows" required>
                </label>
            </div> -->
            <!-- <div class="div-col-1">
                <span class="title-label">Plantas del garaje *</span>
                <label for="">
                    <input type="number" class="input" value="<?= $property[0]["number_of_plants"] ?>" name="number_of_plants" required>
                </label>
            </div> -->
            <!-- <label for="">
            ...
            <!-- <div class="div-col-1">
                <span class="title-label">Otras caracter&iacute;sticas del piso</span>
            ...
            <div class="div-col-1">
                ...
                <label class="checkbox label-radio-checkbox-col-100">
                    <input type="checkbox" class="checkbox-input-ui" <?= !empty($property[0]["bank_owned_property"]) ? "checked" : ""  ?> hidden="" name="bank_owned_property" value="1" />
                    <span class="checkmark-checkbox-input-ui"></span>
                    Inmueble de banco
                </label>
            </div>
            ...
            <div class="div-col-1">
                <span class="title-label">Caracter&iacute;sticas *</span>
                <?php $col_feature_id = array_column($features, "feature_id"); foreach($feature as $fe){ ?>
                <label class="checkbox label-radio-checkbox-col-100">
                    <input type="checkbox" <?= in_array($fe["id"], $col_feature_id) ? "checked" : "" ?> class="checkbox-input-ui" hidden="" name="feature[]" value="<?= $fe["id"] ?>" />
                    <span class="checkmark-checkbox-input-ui"></span>
                    <?= $fe["name"] ?>
                </label>
                <?php } ?>
            ...
            <div class="div-col-1">
                ...
                <?php $col_equipment_id = array_column($equipments, "equipment_id"); foreach($equipment as $equi){ ?>
                <label class="checkbox label-radio-checkbox-col-100">
                    <input type="checkbox" <?= in_array($equi["id"], $col_equipment_id) ? "checked" : "" ?> class="checkbox-input-ui" hidden="" name="equipment[]" value="<?= $equi["id"] ?>" />
                    <span class="checkmark-checkbox-input-ui"></span>
                    <?= $equi["name"] ?>
                </label>
                <?php } ?>
        ...
        <div class="container-row-form box">
            <div class="div-col-1">
                ...
                <label for="">
                    ...
                    <input type="text" class="input" value="<?= $property[0]["energy_consumption"] ?>" name="energy_consumption">
                </label>
            </div>
            <div  class="div-col-1">
                <label for="" class="label-col-100">
                ...
                <label for="">
                    ...
                    <input type="text" class="input" value="<?= $property[0]["emissions_consumption"] ?>" name="emissions_consumption">
                </label>
            </div>
        </div> -->
        ...
        <div class="container-row-form box container-for-rent-only">
            ...
            <div class="div-col-1">
                ...
                <label class="checkbox label-radio-checkbox-col-100">
                    <input type="checkbox" name="appropriate_for_children" value="1" />La vivienda es apropiada para ni&ntilde;os
                </label>
            </div>
            <div class="div-col-1">
                <span class="title-label">&iquest;Admites mascotas? </span>
                <label class="checkbox label-radio-checkbox-col-100">
                    <input type="checkbox" name="pet_friendly" value="1" />S&iacute;, admito mascotas
                </label>
            </div>
        </div> -->
