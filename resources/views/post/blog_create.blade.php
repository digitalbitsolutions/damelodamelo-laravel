...
@section('subheading')
    Publica novedades y contenido para los usuarios
@endsection
...
@section('content')
    <div class="container-main">
        <div class="form-container">
            <h2>Crear nuevo art&iacute;culo de blog</h2>
            <form id="blogPostForm" method="POST" action="{{ url('/post/blogs/article/save') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="title">Titulo del articulo</label>
                    <input type="text" id="title" name="title" placeholder="Introduce el titulo del blog" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="summary" name="summary" placeholder="Escribe un breve resumen..." rows="4" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="image-preview-container">
                        <img id="imagePreview" src="#" alt="Previsualizacion de imagen" style="display: none;">
                ...
                <button type="submit" class="submit-button">Publicar articulo</button>
            </form>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    const response = await fetch('/post/blogs/article/save', {
                        method: 'POST',
                        headers: {
                    ...
                    feedbackMessage.textContent = error.message || 'Error al publicar el articulo.';
