...
@section('css')
    ...
    <meta property="og:image" content="<?= base_url()."img/damelo_damelo.webp" ?>">
    <meta property="og:url" content="https://damelodamelo.com">
        ...
        <section class="banner" >
            <div class="container-title-message">
                ...
                <div class="container-images">
                    <img src="<?= base_url()."img/background-image.webp" ?>" alt="damelo damelo">
                </div>
            </div>
                ...
                <div class="container-1">
                    ...
                    <div class="container-btns-action-main-ctrl">
                        <button id="redirect-property" style="background-color: var(--color-main-1); color: white;">
                            <img src="<?= base_url("img/casa-1.webp") ?>" alt="propiedades damelo damelo">
                            Propiedades
                        </button>
                        <button id="redirect-service">
                            <img src="<?= base_url("img/servicio-1.webp") ?>" alt="servicios damelo damelo">
            ...
            <div class="card-grid">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="<?= base_url()."img/uploads/".$pr["cover_image"]["url"] ?>" alt="damelo damelo">
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-footer">
                            ...
                            <div class="ctn-icons-footer">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 256 256" class="btn-share-facebook" data-url="https://damelodamelo.com/result/<?=$pr["reference"] ?>"><path class="btn-share-facebook" data-url="https://damelodamelo.com/result/<?=$pr["reference"] ?>" fill="#1877F2" d="M256 128C256 57.308 198.692 0 128 0S0 57.308 0 128c0 63.888 46.808 116.843 108 126.445V165H75.5v-37H108V99.8c0-32.08 19.11-49.8 48.348-49.8C170.352 50 185 52.5 185 52.5V84h-16.14C152.959 84 148 93.867 148 103.99V128h35.5l-5.675 37H148v89.445c61.192-9.602 108-62.556 108-126.445"/><path class="btn-share-facebook" data-url="https://damelodamelo.com/result/<?=$pr["reference"] ?>" fill="#FFF" d="m177.825 165l5.675-37H148v-24.01C148 93.866 152.959 84 168.86 84H185V52.5S170.352 50 156.347 50C127.11 50 108 67.72 108 99.8V128H75.5v37H108v89.445A129 129 0 0 0 128 256a129 129 0 0 0 20-1.555V165z"/></svg>
                                <span class="btn-share-facebook" data-url="https://damelodamelo.com/result/<?=$pr["reference"] ?>">Compartir</span>
                            </div>
                        </div>
                    </div>
                </div>
